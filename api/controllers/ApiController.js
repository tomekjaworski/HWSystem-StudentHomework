...
const ApiController = module.exports = {
  ...
  changeMachineStatus: function (req, res) {
    ...
    let generated_rk = md5(data.tid.toString() + data.reply.toString() + data.status.toString() + data.passed.toString() + data.report + data.message + ManageReplies.machine.apiKey)
