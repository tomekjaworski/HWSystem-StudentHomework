/* eslint-disable no-undef,no-self-compare,eqeqeq,no-extend-native,camelcase,one-var,no-mixed-operators */
/*!
...
(function (root, factory) {
  ...
  (function ($) {
    ...
    Selectpicker.DEFAULTS = {
      ...
      style: 'custom-select', // bootstrap4: btn-default replaced by btn-secondary
      size: 'auto',
      title: null,
    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function () {
        ...
        var donebutton = this.multiple && this.options.doneButton
          ...
          : ''
        var drop =
          '<div class="btn-group form-control bootstrap-select' + showTick + inputGroup + '">' +
